...
export default function AboutMe(props) {
  ...
  const SCREEN_CONSTANTS = {
    description: "I am a dedicated and proactive Information Systems student with substantial hands-on experience in software maintenance, bug resolution, and project management. During my internship at ExxonMobil's Vendor Manager Office, I have successfully contributed to contract tracking using advanced technologies such as Python, SQL, OutSystems, HTML, and CSS.",
    highlights: {
      bullets: [
